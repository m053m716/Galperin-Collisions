...
%READOBJ Read *.obj file containing 3D-object vertices and face normals (Courtesy of Bernard Abayowa, Mathworks File Exchange)
%
% obj = io.readObj(fname)
%
...
%
% Inputs
%  fname - wavefront object file full path
%
% Output
%  obj   - Object data struct
%
%       : obj.v   - mesh vertices
...
%
% Retrieved:
% -> Bernard Abayowa (2020). readObj (https://www.mathworks.com/matlabcentral/fileexchange/18957-readobj), MATLAB Central File Exchange. Retrieved December 1, 2020. 
